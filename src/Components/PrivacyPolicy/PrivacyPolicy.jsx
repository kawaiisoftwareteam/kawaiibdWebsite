      ...
      <div className="privacyLayout">
        ...
        <div className="privacyContent">
          ...
          <article id="personal-data" className="privacySection">
            <h2>{t('privacy.sections.personalData')}</h2>
