...
const KawaiiAnatomy = () => {
  ...
  const anatomyTitle = t('about.anatomy.title') || 'Kawaii Group';
      ...
      <div className='anatomyHeadBox'>
        <div className='anatomyLeftBox'>
          <div className='anatomyLeftTitleBox'>
            <svg xmlns="http://www.w3.org/2000/svg" width="93" height="80" viewBox="0 0 93 80" fill="none" aria-hidden="true">
            ...
            <div className='anatomyLeftTitle'>{anatomyTitle}</div>
          </div>
          <div className='anatomyLeftBonding'>
            <img loading="lazy" decoding="async" src={getSrc(kawaiiLeftTitle)} alt={anatomyTitle} />
          </div>
        </div>
        <div className='anatomyRightBonding'>
          <img loading="lazy" decoding="async" src={getSrc(kawaiiRightTitle)} alt={`${anatomyTitle} team`} className='anatomyRightBondingImg' />
        </div>
      </div>
