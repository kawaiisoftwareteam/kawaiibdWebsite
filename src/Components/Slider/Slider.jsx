...
const getImageSrc = (img) => (typeof img === 'string' ? img : img?.src || img);

const slideImages = [
  getImageSrc(sliderImage1),
  getImageSrc(sliderImage2),
  getImageSrc(sliderImage3),
  getImageSrc(sliderImage4),
];
  ...
  return (
    ...
    >
      <Fade
        ...
        onChange={(from, to) => setActiveIndex(to !== undefined ? to : from)}
      >
            ...
            <div key={index}>
              <div className="heroSlide" style={{ backgroundImage: `url(${imageUrl})` }}>
                ...
                <div className="heroCopyBox">
                  ...
                  <Link href={localizedPath(slide.link || '/')} className="heroButton">
