...
const Seminar = () => {
  ...
  return (
    <div className="seminar-container min-h-screen pb-4 sm:pb-8">
      ...
      <div className="seminar-page-shell mb-8 sm:mb-12 bg-gray-900 text-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 border border-gray-800">
        <div className="space-y-2 text-center md:text-left w-full md:w-auto">
          ...
          <h2 className="text-xl sm:text-3xl font-extrabold tracking-tight">{t('seminar.urgency.title')}</h2>
          <p className="text-sm sm:text-base text-gray-400">{t('seminar.urgency.dateLabel')}</p>
        </div>
      ...
      <div className="seminar-page-shell grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] xl:grid-cols-[minmax(0,1fr)_minmax(300px,360px)] gap-8 items-start mb-16">
        ...
        <div className="space-y-8 min-w-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-3 sm:gap-4 hover-card-effect">
              ...
              <div className="min-w-0">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{t('seminar.meta.date.label')}</h4>
                <p className="text-lg sm:text-2xl font-bold text-gray-850 mt-1">{t('seminar.meta.date.value')}</p>
                <p className="text-sm sm:text-base text-gray-550 mt-1">{t('seminar.meta.date.note')}</p>
              </div>
            </div>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-3 sm:gap-4 hover-card-effect">
              ...
              <div className="min-w-0">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{t('seminar.meta.time.label')}</h4>
                <p className="text-lg sm:text-2xl font-bold text-gray-850 mt-1">{t('seminar.meta.time.value')}</p>
                <p className="text-sm sm:text-base text-gray-550 mt-1">{t('seminar.meta.time.note')}</p>
              </div>
            </div>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-3 sm:gap-4 hover-card-effect">
              ...
              <div className="min-w-0">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{t('seminar.meta.location.label')}</h4>
                <p className="text-lg sm:text-2xl font-bold text-gray-850 mt-1">{t('seminar.meta.location.value')}</p>
                <p className="text-sm sm:text-base text-gray-550 mt-1">{t('seminar.meta.location.note')}</p>
              </div>
            </div>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-3 sm:gap-4 hover-card-effect">
              ...
              <div className="min-w-0">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{t('seminar.meta.incentives.label')}</h4>
                <p className="text-lg sm:text-2xl font-bold text-gray-850 mt-1">{t('seminar.meta.incentives.value')}</p>
                <p className="text-sm sm:text-base text-gray-550 mt-1">{t('seminar.meta.incentives.note')}</p>
              </div>
            </div>

            <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-3 sm:gap-4 hover-card-effect sm:col-span-2">
              <div className="p-3 sm:p-4 bg-rose-50 text-[#be1e2d] rounded-xl flex-shrink-0">
                <FaInfoCircle className="text-2xl sm:text-3xl" />
              </div>
              <div className="min-w-0">
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">{t('seminar.meta.deadline.label')}</h4>
                <p className="text-lg sm:text-2xl font-bold text-gray-850 mt-1">{t('seminar.meta.deadline.value')}</p>
                <p className="text-sm sm:text-base text-gray-550 mt-1">{t('seminar.meta.deadline.note')}</p>
              </div>
            </div>
          </div>
          ...
          <div id="speaker-section" className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-150 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 sm:gap-8">
              ...
              <div className="w-full md:w-48 flex flex-col items-center gap-4 flex-shrink-0">
                ...
                <div className="w-full grid grid-cols-2 gap-2 bg-gray-50 p-3 rounded-xl border border-gray-100 text-center">
                  <div>
                    ...
                    <div className="text-[10px] text-gray-400 uppercase font-bold">{t('seminar.speaker.stats.gcRd')}</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-gray-800">20+</div>
                    <div className="text-[10px] text-gray-400 uppercase font-bold">{t('seminar.speaker.stats.papers')}</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-gray-800">10</div>
                    <div className="text-[10px] text-gray-400 uppercase font-bold">{t('seminar.speaker.stats.patents')}</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-gray-800">2</div>
                    <div className="text-[10px] text-gray-400 uppercase font-bold">{t('seminar.speaker.stats.committees')}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 flex-1">
                <div>
                  <h3 className="text-3xl font-black text-gray-900">{t('seminar.speaker.name')}</h3>
                  <p className="text-lg font-semibold text-[#be1e2d] mt-1">{t('seminar.speaker.role')}</p>
                  <p className="text-sm text-gray-450 mt-0.5">{t('seminar.speaker.company')}</p>
                </div>
                ...
                <div className="space-y-2 border-t border-gray-100 pt-3">
                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider">{t('seminar.speaker.timelineTitle')}</h4>
          ...
          <div id="special-guest-section" className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-150 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
              ...
              <div className="space-y-2 text-center sm:text-left flex-1">
                <h3 className="text-2xl sm:text-3xl font-black text-gray-900">{t('seminar.specialGuest.name')}</h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-150 space-y-6">
            <h3 className="text-2xl font-bold text-gray-900">{t('seminar.modules.title')}</h3>
        ...
        <div className="space-y-8 lg:sticky lg:top-24">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-150 sharing-card space-y-6 flex flex-col items-center">
            <div className="text-center">
              <h3 className="font-bold text-gray-800 text-xl">{t('seminar.share.title')}</h3>
              <p className="text-base text-gray-500 mt-2">{t('seminar.share.desc')}</p>
            </div>
            ...
            <div className="w-full space-y-3 pt-2">
              ...
              >
                {copied ? <><FaCheckCircle className="text-green-500" /> {t('seminar.share.linkCopied')}</> : <><FaCopy /> {t('seminar.share.copyLink')}</>}
              </button>
              <a
          ...
          <div className="bg-rose-50/50 p-6 rounded-3xl border border-rose-100 flex items-start gap-4">
            ...
            <div className="text-sm text-rose-800 space-y-1.5 leading-relaxed">
              <p className="font-bold">{t('seminar.help.title')}</p>
              <p>{t('seminar.help.text')} <a href="mailto:info@kawaiibd.com" className="font-semibold underline">info@kawaiibd.com</a>.</p>
            </div>
          </div>
        </div>
      </div>
